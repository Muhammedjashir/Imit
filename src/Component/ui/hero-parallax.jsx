...
const contentData = [
  {
    ...
    description: "Transforming ideas into stunning websites. Our web development experts ensure your online success. Explore the art of digital excellence with us!",
    image: "https://imitpark.com/webimg/banner02.webp",
  },
  {
    title: "Digital Marketing",
    description: "Drive digital success with our expert strategies. From clicks to conversions, we're your partner in online growth. Let's craft your digital triumph together!",
    image: "https://imitpark.com/webimg/banner03.webp",
  },
  {
    title: "Graphic Design & Media",
    description: "From visuals to stories, we craft all your media needs. Let's bring your brand to life with our artistic touch!",
    image: "https://imitpark.com/webimg/banner04.webp",
  },
  {
    title: "Mobile App Development",
    description: "Improve your digital presence with our experts in Web and mobile Apps, Web Design, and UI/UX Design. Your vision, our innovation. Let's build together!",
    ...
    <div className="max-w-7xl w-full flex justify-center">
      ...
      >
        ...
        <div className="max-w-md lg:ml-50 text-center lg:text-left">
          <div className="break-words max-w-[250px]">
            <h2 className="text-3xl lg:text-4xl font-bold">
              <span className="text-orange-500">{contentData[index].title.split(" ")[0]}</span>
              <span className="text-blue-900">{" "}{contentData[index].title.split(" ").slice(1).join(" ")}</span>
            </h2>
          </div>
          <p className="mt-4 text-blue-900 text-2xl">{contentData[index].description}</p>
          <a 
            href="#"
        ...
        <motion.img
          ...
          className="h-[500px] translate-y-[-30px]"
