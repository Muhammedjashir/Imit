  ...
  return (
    <div className="bg-white relative w-full">
      <div className="max-w-sm md:max-w-4xl mx-auto antialiased font-sans px-4 md:px-8 lg:px-12 py-20 w-full">
        <div className="relative grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-20 w-full">
          ...
          <div className="flex justify-between flex-col py-4 w-full">
            ...
            >
              ...
              <p className="text-2xl text-gray-900 dark:text-neutral-700 font-medium">
                {testimonials[active].designation}
              </p>
              <motion.p className="text-lg text-gray-700 mt-8 dark:text-neutral-500 w-full">
